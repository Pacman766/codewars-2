...
function getCard() {
  ...
  for(let i = 0; i<5; i ++) {
    let res = `B${getRandomIntInclusive(1,15)}`;
    if(!arr.includes(res)) {
      arr.push(res)
    } else {i--}
  }
  for(let i = 0; i<5; i ++) {
    let res = `I${getRandomIntInclusive(16,30)}`;
    if(!arr.includes(res)) {
      arr.push(res)
    } else {i--}
  }
  for(let i = 0; i<5; i ++) {
    let res = `N${getRandomIntInclusive(31,45)}`;
    if(i === 2) {}
  ...
  for(let i = 0; i<5; i ++) {
    let res = `G${getRandomIntInclusive(46,60)}`;
    if(!arr.includes(res)) {
      arr.push(res)
    } else {i--}
  }
  for(let i = 0; i<5; i ++) {
    let res = `O${getRandomIntInclusive(61,75)}`;
    if(!arr.includes(res)) {
      arr.push(res)
    } else {i--}
  }
